...
alias vm-d="qemu-kvm  -vga qxl -spice addr=127.0.0.1,port=5901,disable-ticketing \
...
alias vm-f="qemu-kvm  -vga qxl -spice addr=127.0.0.1,port=5902,disable-ticketing \
